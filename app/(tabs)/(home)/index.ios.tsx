// Full iOS implementation — mirrors index.tsx exactly.
// IMPORTANT: Do NOT re-export from ./index — Metro resolves that to index.ios.tsx on iOS,
// causing a circular import crash. This file must be self-contained.
...
export default function HomeScreen() {
  ...
  useEffect(() => {
    ...
    console.log('[Sacred Home] mounted build 34');
