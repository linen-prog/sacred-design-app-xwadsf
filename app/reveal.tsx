...
const styles = StyleSheet.create({
  ...
  narrativeCard: {
    ...
    shadowColor: 'rgba(70,55,40,0.12)',
  ...
  ctaSecondaryButton: {
    ...
    justifyContent: 'center',
    borderWidth: 1,
    borderColor: 'rgba(220,185,100,0.40)',
    backgroundColor: 'rgba(255,248,238,0.35)',
  },
  ctaSecondaryLabel: {
    fontFamily: 'Inter_600SemiBold',
    fontSize: 16,
  ...
  promptCard: {
    ...
    paddingTop: 16,
    paddingBottom: 40,
    shadowColor: 'rgba(70,55,40,0.15)',
  ...
  promptPrimaryButton: {
    backgroundColor: 'rgba(74,96,67,0.85)',
    borderRadius: 50,
    height: 56,
    alignItems: 'center',
    justifyContent: 'center',
